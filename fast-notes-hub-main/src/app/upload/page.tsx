    ...
    <div className="space-y-4">
      <input 
        ...
        className={`w-full border border-gray-300 rounded px-3 py-2 
          text-sm file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:bg-blue-600 file:text-white hover:file:bg-blue-700 cursor-pointer ${
        ...
        <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <div className="space-y-1 max-h-32 overflow-y-auto">
            {files.map((file, index) => (
              <div key={index} className="flex items-center justify-between text-xs text-blue-700 bg-blue-100 p-2 rounded">
