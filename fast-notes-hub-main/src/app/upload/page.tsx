...
export default function UploadPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="max-w-md w-full mx-auto mt-10 p-6 border border-gray-800 rounded-lg shadow-xl bg-gray-900">
        <h2 className="text-2xl font-semibold mb-6 text-center text-white">Upload Documents</h2>
        ...
        <div className="space-y-4">
          <input
            ...
            className={`w-full border border-gray-700 rounded px-3 py-2 
              text-sm file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:bg-blue-600 file:text-white hover:file:bg-blue-700 cursor-pointer bg-gray-900 text-white ${
            ...
            <div className="p-3 bg-gray-800 rounded-lg border border-gray-700">
              ...
              <div className="space-y-1 max-h-32 overflow-y-auto">
                {files.map((file, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between text-xs text-blue-300 bg-gray-700 p-2 rounded"
                  >
          ...
          <input
            ...
            className={`w-full border border-gray-700 rounded px-3 py-2 text-sm bg-gray-900 text-white placeholder:text-gray-500 ${
              isUploading ? "opacity-50 cursor-not-allowed" : ""
            }`}
          />
          <select
            ...
            className={`w-full border border-gray-700 rounded px-3 py-2 text-sm bg-gray-900 text-white ${
              isUploading ? "opacity-50 cursor-not-allowed" : ""
            }`}
          >
            ...
            <optgroup label="Semester 3">
              ...
              <option value="SS2002">SS2002 - Fundamentals of Economics</option>
              <option value="MG1001">MG1001 - Fundamentals of Management</option>
              <option value="AF1001">AF1001 - Fundamentals of Accounting</option>
            </optgroup>
          ...
          >
            {isUploading ? (
              <div className="flex items-center justify-center space-x-2">
                ...
                <span>
                  Uploading... {currentFileIndex}/{files.length} ({uploadProgress.toFixed(0)}%)
                </span>
              </div>
            ) : (
