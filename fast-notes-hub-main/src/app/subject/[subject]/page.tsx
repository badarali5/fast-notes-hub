      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-6">
        ...
        <Tabs value={activeTab} onValueChange={(val) => setActiveTab(val as TabType)} className="w-full">
          ...
          >
            ...
            <TabsTrigger
              value="slides"
              className="data-[state=active]:bg-blue-950 data-[state=active]:text-blue-300 text-gray-400 text-sm font-semibold flex items-center justify-center rounded-full bg-muted px-3 py-1 transition cursor-pointer whitespace-nowrap"
            >
